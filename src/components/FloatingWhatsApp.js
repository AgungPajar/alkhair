...
export default function FloatingWhatsApp() {
  return (
    <a
      href="https://wa.me/6282393363313?text=Assalamu%27alaikum%20Admin%20Rumah%20Qur%27ani%20Al-Khair%20Cerdiq,%20saya%20ingin%20bertanya%20mengenai%20program%20pendidikan."
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:scale-110 transition-transform duration-300 hover:shadow-xl focus:outline-none"
